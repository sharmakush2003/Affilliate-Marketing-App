# Dedicated Git Status & Sync Script for Affilliate-Marketing-App
# Target GitHub Repository: https://github.com/sharmakush2003/Affilliate-Marketing-App.git

$projectName = "Affilliate-Marketing-App"
$targetRemote = "https://github.com/sharmakush2003/Affilliate-Marketing-App.git"
