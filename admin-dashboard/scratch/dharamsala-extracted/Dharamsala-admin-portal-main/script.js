...
function getNextReceiptNumber() {
    ...
    allData.forEach(r => {
        let receiptNo = r["Check In Bill No"] || r["Receipt No"] || "";
        if (typeof receiptNo !== 'string') {
            receiptNo = String(receiptNo);
        }
        // Match both IN-XXX and OUT-XXX patterns (with hyphen, space, or none) or pure numbers
        const match = receiptNo.match(/(?:IN|OUT)[-\s]?(\d+)/) || receiptNo.match(/^(\d+)$/);
        if (match) {
...
const ROOM_CATEGORIES = {
    ...
    "Non AC": ["19", "20", "114", "115", "116", "117", "118", "119", "120", "121", "126", "127", "129", "130", "131", "132", "133", "134", "135", "136", "137", "138", "139"],
